...
7. [Deux écoles de tests unitaires](#two-schools-of-unit-testing)
    * [Classique](#classical)
    * [Moqueuse](#mockist)
    * [Dépendances](#dependencies)
8. [Mock vs Stub](#mock-vs-stub)
9. [Trois styles de tests unitaires](#three-styles-of-unit-testing)
    * [Sortie](#output)
    * [État](#state)
    * [Communication](#communication)
10. [Architecture fonctionnelle et tests](#functional-architecture-and-tests)
11. [Comportement observable vs détails d'implémentation](#observable-behavior-vs-implementation-details)
12. [Unité de comportement](#unit-of-behavior)
